...
- 저 또한 부족한 점이 많습니다. 시행착오를 겪는 중이고 이런 케이스도 있구나 정도로 참고하면 좋을 것 같습니다
...
2020년 11월 18일 기준 88개의 테스트코드를 실행하고 있습니다

![](./images/3-2.png)

총 11905라인의 코드중 84.8% 의 코드가 테스트되고 있음을 알수있습니다

# 코드 커밋

### [azure devops release flow](https://docs.microsoft.com/en-us/azure/devops/learn/devops-at-microsoft/release-flow) 브랜치 전략을 사용합니다
