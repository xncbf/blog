...
- [개요](#개요)
- [참고사항](#참고사항)
- [트래픽을 고려하지않는 서버 설계 (1~100)](#트래픽을-고려하지않는-서버-설계-1100)
- [이제는 확장을 고려할 때 (100~1K)](#이제는-확장을-고려할-때-1001k)
- [DB도 느리다 (1K~10K)](#db도-느리다-1k10k)
- [컨텐츠는 CDN (10K~100K)](#컨텐츠는-cdn-10k100k)
- [메세지 큐 (100K~1M)](#메세지-큐-100k1m)
- [아무리 나눠도 DB 가 느리다 (1M~50M)](#아무리-나눠도-db-가-느리다-1m50m)
- [결론](#결론)
